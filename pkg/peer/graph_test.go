...
//	b := root.ToPeer(name.New("b"))
//	c := b.ToPeer(name.New("c"))
//	d := c.ToPeer(name.New("d"))
//	e := d.ToPeer(name.New("e"))
//	e.AddPeer(root)
//	return root
//}
//
...
//	x := root.ToPeer(name.New("x"))
//	y := root.ToPeer(name.New("y"))
//	z := root.ToPeer(name.New("z"))
//	x.AddPeer(y)
//	y.AddPeer(x)
//	y.AddPeer(z)
//	z.AddPeer(y)
