...
var (
	...
	// IPFSPeers are well known DHT peers.
	//
	// This is similar to hard coding "8.8.8.8" into DNS lookup for IPv4 and traditional
	// DNS.
	//
	// There are ways of finding a current list using the ipfs command line tool.
	//
	// More: https://docs.ipfs.io/how-to/modify-bootstrap-list/
	IPFSPeers []peer.AddrInfo = convertPeers([]string{
